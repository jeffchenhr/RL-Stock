...
if __name__ == '__main__':
    ...
    downloader = Downloader('./stockdata/train', date_start='2010-01-01', date_end='2019-11-29')
    downloader.run()

    mkdir('./stockdata/test')
    downloader = Downloader('./stockdata/test', date_start='2019-12-01', date_end='2020-3-31')
    downloader.run()
